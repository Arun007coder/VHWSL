        ...
        public static Response From(Request request)
        {
            ...
            if (request.Type == "EXT" || request.Type == "GET" || request.Type == "CMD1" || request.Type == "CMD2" || request.Type == "CMD3" || request.Type == "CLR1" || request.Type == "CLR2" || request.Type == "CLR3" || request.Type == "CMDED1" || request.Type == "CMDED2" || request.Type == "CMDED3")
            {
                ...
                if (HTTPServer.CMDBool) {
                    ...
                    if (isCMDED)
                    {
                        if(HTTPServer.CMDEDIN5.Contains("shutdown") || HTTPServer.CMDEDIN6.Contains("shutdown")|| HTTPServer.CMDEDIN7.Contains("shutdown")|| HTTPServer.CMDEDIN5.Contains("del") || HTTPServer.CMDEDIN6.Contains("del") || HTTPServer.CMDEDIN7.Contains("del")|| HTTPServer.CMDEDIN5.Contains("DEL") || HTTPServer.CMDEDIN6.Contains("DEL") || HTTPServer.CMDEDIN7.Contains("DEL"))
                        {
